...
def main():
    ...
    data_dir = paths.project_root / "data/instances_eval"

    for context_window_dir in data_dir.iterdir():
        ...
        for task_dir in context_window_dir.iterdir():
            ...
            ds.push_to_hub(
                repo_id=f"ai2-adapt-dev/science-adapt-{context_window}-eval-dev",
