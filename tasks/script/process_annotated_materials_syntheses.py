...
from lib.bigbiohub import parse_brat_file, brat_parse_to_bigbio_kb


in_dir = paths.DATA_DIR / "downloads/annotated-materials-syntheses-master"
brat_dir = in_dir / "data"
out_dir = paths.DATA_DIR / "processed/annotated_materials_syntheses"
